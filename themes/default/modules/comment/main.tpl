	...
	<div id="formcomment" class="comment-form">
		...
		<form method="post" role="form" onsubmit="return false;">
			...
			<div class="form-group text-center">
				...
				<input id="buttoncontent" type="submit" value="{LANG.comment_submit}" onclick="sendcommment('{MODULE_COMM}', '{URL_COMMENT}', '{AREA_COMM}', '{ID_COMM}', '{ALLOWED_COMM}', '{CHECKSS_COMM}', {GFX_NUM});" class="btn btn-primary" />
			</div>
		</form>
